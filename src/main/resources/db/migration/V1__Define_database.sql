alter table if exists documents_comments drop constraint if exists FKi9vb30bfcr0f2cofyehbhfgmb;
alter table if exists documents_resources drop constraint if exists FKmi1seh00tbtd2wga71mhvx113;
...
alter table if exists step_documents drop constraint if exists FK35raeea7voc5eor5rr9b4lt09;
...
create table documents (process_id varchar(255) not null, title varchar(255) not null, file oid, format varchar(255), primary key (process_id, title));
create table documents_comments (process_id varchar(255) not null, title varchar(255) not null, comments varchar(255));
create table documents_resources (process_id varchar(255) not null, title varchar(255) not null, resources varchar(255));
...
create table step_documents (process_id varchar(255) not null, title varchar(255) not null, documents_process_id varchar(255) not null, documents_title varchar(255) not null, primary key (process_id, title, documents_process_id, documents_title));
...
alter table if exists step_documents add constraint UK_hd7bwu14gc3flg8bis8145us6 unique (documents_process_id, documents_title);
...
alter table if exists documents_comments add constraint FKi9vb30bfcr0f2cofyehbhfgmb foreign key (process_id, title) references documents;
alter table if exists documents_resources add constraint FKmi1seh00tbtd2wga71mhvx113 foreign key (process_id, title) references documents;
...
alter table if exists step_documents add constraint FK35raeea7voc5eor5rr9b4lt09 foreign key (documents_process_id, documents_title) references documents;
