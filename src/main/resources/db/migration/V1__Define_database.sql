...
alter table if exists invites drop constraint if exists FKif1w0xba5i9tmrnxufujyhnrl;
alter table if exists invites drop constraint if exists FKrvwicfhd6ilg6jh4epdhssj46;
...
alter table if exists processes drop constraint if exists FKt9j32yx5dfs60v6wk2x84vfbc;
...
create table invites (id int8 generated by default as identity, candidate_id int8, team_title varchar(255), primary key (id));
...
create table processes (id varchar(255) not null, current_step int4, title varchar(255), team_id varchar(255), primary key (id));
...
alter table if exists invites add constraint FKif1w0xba5i9tmrnxufujyhnrl foreign key (candidate_id) references participants;
alter table if exists invites add constraint FKrvwicfhd6ilg6jh4epdhssj46 foreign key (team_title) references teams;
...
alter table if exists processes add constraint FKt9j32yx5dfs60v6wk2x84vfbc foreign key (team_id) references teams on delete cascade;
