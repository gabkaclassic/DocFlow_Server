...
alter table if exists processes drop constraint if exists FKm0wd0b2e495curuveagsu9v5u;
...
create table processes (id varchar(255) not null, current_step int4, title varchar(255), processes_id varchar(255), primary key (id));
...
alter table if exists processes add constraint FKm0wd0b2e495curuveagsu9v5u foreign key (processes_id) references teams on delete cascade;
